...
class Network
{
	public:
		vector<Node> Nodes;
		void generatePerturbation(double amp, int seed);
...
void Network::generatePerturbation(double amp, int seed)
{
	int i;
...
int main(int argc, char **argv)
{
	int i;
	char Str[512];
	Network N = GenerateNetwork(100,3,0.99);
	...
	for (i=0;i<100;i++)
	{
		...
		for (amp=0.001;amp<=1;amp*=1.15)
		{
			N.generatePerturbation(amp, i);
